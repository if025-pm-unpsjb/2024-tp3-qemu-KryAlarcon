...
#define TASK4_PERIOD 	10000
#define TASK5_PERIOD 	15000
...
xTask task4 = { TASK4_WCET, TASK3_PERIOD };
xTask task5 = { TASK5_WCET, TASK3_PERIOD };
...
void prvTask( void *pvParameters )
{
	...
	for( ;; )
	{
       // sprintf( cMessage, "%s - %u\n\r", pcTaskGetTaskName( NULL ), uxReleaseCount );
		...
		snprintf(cMessage, mainMAX_MSG_LEN, "%s - %u - %d\n\r",
        ...
        snprintf(cMessage, mainMAX_MSG_LEN, "%s - %u - end: %d\n\r",
                                		             pcTaskGetTaskName(NULL),
                                		             uxReleaseCount,
                                		             (unsigned int)xTaskGetTickCount());
